      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-slate-400 mt-2 max-w-xl">
            Industry-recognised certifications validating expertise across cloud, AI, and engineering practices.
          </p>
        </motion.div>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-2 mb-1">
                  ...
                  <span className={`shrink-0 text-xs px-2 py-0.5 rounded-full border font-mono ${categoryColors[cert.category] ?? 'text-slate-400 bg-slate-700 border-slate-600'}`}>
                    {cert.category}
                  </span>
                </div>
